        ...
        <div className="m-8 f-center">
          <div className="container f-center gap-x-5 flex-wrap flex-col lg:flex-row">
            <div className="flex flex-col w-full lg:w-1/3 justify-center items-start text-center md:text-left">
              <h1 className="my-2 text-6xl font-bold leading-[1]">
        ...
        <div className="bg-light-purple py-8">
          <div className="container max-w-5xl mx-auto m-8 mb-20">
            ...
            <div className="flex flex-wrap justify-center">
              <HorizontalCard img="https://www.nyse.com/publicdocs/images/NYSE_Trading_Floor_New_Branding.jpg" />
            </div>
          </div>
        </div>
      </section>

      <div className="relative -mt-12 lg:-mt-[70px]">
        <svg
          viewBox="0 0 1428 174"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
          transform="scale(1, -1)" // Add this transform attribute
        >
